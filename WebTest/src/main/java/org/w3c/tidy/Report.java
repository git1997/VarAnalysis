...
public final class Report
{
        ...
        throws MissingResourceException
    {
        ...
        resource = res.containsKey(message) ? res.getString(message) : message;
        ...
        String errorMessage = position + prefix + messageString;
    ...
    public void encodingError(Lexer lexer, int code, int c)
    {
        ...
        if (lexer.configuration.showWarnings)
        {
            ...
            // INST ADDED BY HUNG
            	...
            	printMessage(code, lexer, "Warning code " + code + " (see org.w3c.tidy.Report)", new Object[]{new Integer(code & DISCARDED_CHAR), buf}, Level.WARNING);
        	}
        }
    }
    ...
    public void error(Lexer lexer, Node element, Node node, short code)
    {
        ...
        // INST ADDED BY HUNG
        // (Currently commented out since in a subject system, these errors turn out to be false positives.)
        //else {
        //	printMessage(code, lexer, "Error code " + code + " (see org.w3c.tidy.Report)", null, Level.ERROR);
    	//}
    }
    ...
    // INST ADDED BY HUNG
    private static IErrorListener errorListener = null;
    
    public static void setErrorListener(IErrorListener errorListener) {
    	Report.errorListener = errorListener;
    }
