...
public class SaxParserEnv {
	...
	public void updateAfterParsingBranches(Constraint constraint, SaxParserEnv trueBranchEnv, SaxParserEnv falseBranchEnv) {
		 ...
		 * Check the state
		 */
		if (trueBranchEnv.parsingState != falseBranchEnv.parsingState) {
			if (trueBranchEnv.parsingState == ParsingState.INSIDE_TEXT && falseBranchEnv.parsingState == ParsingState.OUTSIDE_TEXT
					|| trueBranchEnv.parsingState == ParsingState.OUTSIDE_TEXT && falseBranchEnv.parsingState == ParsingState.INSIDE_TEXT) {
