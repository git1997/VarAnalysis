...
public class Test {
    ...
    private void test1() throws Z3Exception, TestFailedException {
    	Context ctx = new Context();
        System.out.println("FindModelExample1");
    ...
    private void test2() throws Z3Exception, TestFailedException {
    	Context ctx = new Context();
        System.out.println("FindModelExample2");
    ...
    {
    	//System.load("/Work/Eclipse/workspace/scala/VarAnalysis-Tool/z33/lib/libz3.dylib");
    	Test p = new Test();
    	p.test1();
    	p.test2();
