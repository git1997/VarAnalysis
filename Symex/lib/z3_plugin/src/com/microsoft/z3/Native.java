...
public final class Native {
  ...
  protected static native boolean INTERNALgetParamValue(long a0, String a1, StringPtr a2);
  ...
  protected static native int INTERNALgetImpliedEqualities(long a0, int a1, long[] a2, int[] a3);
  ...
  public static long mkContext(long a0)
  {
      long res = INTERNALmkContext(a0);
      return res;
  }

  public static long mkContextRc(long a0)
  {
  ...
  public static boolean getParamValue(long a0, String a1, StringPtr a2) throws Z3Exception
  {
      boolean res = INTERNALgetParamValue(a0, a1, a2);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsgEx(a0, err.toInt()));
      return res;
  ...
  public static int getImpliedEqualities(long a0, int a1, long[] a2, int[] a3) throws Z3Exception
  {
      int res = INTERNALgetImpliedEqualities(a0, a1, a2, a3);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsgEx(a0, err.toInt()));
      return res;
