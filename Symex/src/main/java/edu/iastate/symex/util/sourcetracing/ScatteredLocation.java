...
public class ScatteredLocation extends Location {
	 ...
	 * Constructor
	 */
	public ScatteredLocation(Location firstHalfLocation,
			Location secondHalfLocation, int firstHalfLength) {
	...
	public SourceCodeLocation getLocationAtOffset(int offsetPosition) {
		if (offsetPosition < firstHalfLength)
			...
			return secondHalfLocation.getLocationAtOffset(offsetPosition
					- firstHalfLength);
	}
	...
	public Element printToXmlFormat(Document document, int offsetPosition) {
		if (offsetPosition < firstHalfLength)
			...
			return secondHalfLocation.printToXmlFormat(document, offsetPosition
					- firstHalfLength);
	}
